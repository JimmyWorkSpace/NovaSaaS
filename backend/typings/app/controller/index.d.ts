...
import ExportToolAihuman = require('../../../app/controller/tool/aihuman');
import ExportToolGen = require('../../../app/controller/tool/gen');
import ExportToolImage = require('../../../app/controller/tool/image');
...
declare module 'egg' {
  interface IController {
    ...
    tool: {
      aihuman: ExportToolAihuman;
      gen: ExportToolGen;
      image: ExportToolImage;
